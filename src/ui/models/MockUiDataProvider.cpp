...
constexpr std::array<UiAmsSummary, 6> kAmsUnits{{
    ...
    {2, 3, 0, 4, false, UiConnectionState::Connected},
    {2, 4, 0, 4, false, UiConnectionState::Connected},
    {3, 0, 0, 0, false, UiConnectionState::Offline},
}};

constexpr std::array<UiTraySummary, 9> kTrays{{
    {1, 1, 0, 42, UiTrayState::Loaded, {0xF5F5F5, 0x212121, 0}, 2, 642.0F, "PLA", false, true, true},
    {1, 1, 1, 51, UiTrayState::Ready, {0xE53935, 0, 0}, 1, 811.0F, "PETG", false, true, false},
    {1, 1, 2, 67, UiTrayState::Ready, {0x1E88E5, 0x00ACC1, 0xF5F5F5}, 3, 504.0F, "PLA", false, true, false},
    {1, 1, 3, 0, UiTrayState::Empty, {0x616161, 0, 0}, 0, 0.0F, "", false, false, false},
    {1, 0xFF, 0xFF, 73, UiTrayState::Ready, {0x43A047, 0, 0}, 1, 730.0F, "TPU", true, true, false},
    {2, 2, 0, 81, UiTrayState::Ready, {0x8E24AA, 0, 0}, 1, 920.0F, "PLA", false, true, false},
    {2, 2, 1, 82, UiTrayState::Loaded, {0xFB8C00, 0x212121, 0}, 2, 377.0F, "ABS", false, true, true},
    {2, 2, 2, 83, UiTrayState::Ready, {0x00ACC1, 0, 0}, 1, 756.0F, "PETG", false, true, false},
    {2, 2, 3, 84, UiTrayState::Ready, {0x212121, 0, 0}, 1, 488.0F, "ASA", false, true, false},
}};
...
constexpr UiSpoolSummary kSpool{
    91, "Bambu Lab", "PLA Basic", "PLA", {0xFDD835, 0xFB8C00, 0x212121}, 3,
...
const std::array<UiAmsSummary, 6>& amsUnits() { return kAmsUnits; }
